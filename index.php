...
echo "Nombres d'instance pour la classe Personnage: " . Personnage::getNumInstances() . "<br>";
$numberDragon = new Dragon();

echo "Nombres d'instance pour la classe dragon Dragon: " . Dragon::numInstancesDragon();
